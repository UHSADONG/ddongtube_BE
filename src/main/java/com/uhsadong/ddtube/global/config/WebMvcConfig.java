...
import com.uhsadong.ddtube.global.logger.MdcLoggingInterceptor;
import com.uhsadong.ddtube.global.security.CurrentUserArgumentResolver;
import com.uhsadong.ddtube.global.security.CurrentUserCodeArgumentResolver;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> resolvers) {
        ...
        resolvers.add(new CurrentUserCodeArgumentResolver(jwtUtil));
    }
